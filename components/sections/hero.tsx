          ...
          <div className="flex flex-row px-4 py-4">
            ...
            <div className="flex-1 flex flex-col pr-4">
              ...
              <div className="border-t border-edge pt-3">
                <h2 className="text-sm font-poppins font-semibold mb-2 flex items-center gap-2">
                  about
                </h2>
            ...
            <div className="shrink-0 flex items-start">
              <div className="relative group aspect-square w-14 h-14">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
              </div>
            </div>
          </div>
        ) : (
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className=" border-edge border-t-0">
                <div className="px-4 py-3 sm:py-4">
                  <h1 className="text-3xl sm:text-4xl font-poppins font-semibold mb-2">
                    hi, shujan here
                  </h1>
                </div>
              </div>
